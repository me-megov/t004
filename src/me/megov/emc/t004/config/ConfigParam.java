...
public enum ConfigParam {
    ...
    STATSFILE(          "statsFile",      "stats.txt",        "Statistics report filename"),    
    IS_DEBUG(           "isDebug",        "0",                "Enable debug output (=1)"),
    IS_SAVE_STATS(      "isSaveStats",    "0",                "Enable save statistics file (=1)"),    
